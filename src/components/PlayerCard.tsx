    ...
    >
      <div className="aspect-[3/4] relative overflow-hidden">
        ...
        <div className="absolute bottom-4 right-4 flex gap-2 transform translate-y-10 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
          {twitter && (
            <a href={twitter} target="_blank" rel="noopener noreferrer" className="p-2 bg-rat-dark/80 rounded-full hover:bg-white/20 text-white transition-colors">
              <Twitter className="w-5 h-5" />
            </a>
          )}
          {twitch && (
            <a href={twitch} target="_blank" rel="noopener noreferrer" className="p-2 bg-rat-dark/80 rounded-full hover:bg-white/20 text-white transition-colors">
      ...
      <div className="p-6">
        <h3 className="text-white text-2xl font-heading font-bold mb-1">{name}</h3>
